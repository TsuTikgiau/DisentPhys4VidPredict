...
class SlideDataset(VarLenFeatureVideoDataset):
    def __init__(self, *args, **kwargs):
        super(SlideDataset, self).__init__(*args, **kwargs)
        ...
        self.state_like_names_and_shapes['friction'] = 'friction', [1]
        self.static_state['setting'] = 'setting', [5]

    def get_default_hparams_dict(self):
        default_hparams = super(SlideDataset, self).get_default_hparams_dict()
        hparams = dict(
            context_frames=4,
            sequence_length=10,
            random_crop_size=0,
