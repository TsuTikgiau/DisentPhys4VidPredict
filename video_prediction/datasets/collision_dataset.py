...
class CollisionDataset(VarLenFeatureVideoDataset):
    def __init__(self, *args, **kwargs):
        ...
        self.state_like_names_and_shapes['speed_left_x'] = 'speed_left_x', [1]
        self.state_like_names_and_shapes['speed_right_x'] = 'speed_right_x', [1]
        self.state_like_names_and_shapes['position_left_x'] = 'position_left_x', [1]
        self.state_like_names_and_shapes['position_right_x'] = 'position_right_x', [1]
        self.static_state['setting_left'] = 'setting_left', [5]
        self.static_state['setting_right'] = 'setting_right', [5]

    def get_default_hparams_dict(self):
        default_hparams = super(CollisionDataset, self).get_default_hparams_dict()
        hparams = dict(
            context_frames=4,
            sequence_length=10,
            random_crop_size=0,
